...
import {
  ...
  type StudentProfileCompleteInput,
  BLOOD_GROUPS,
...
export function StudentCompleteProfileForm({ userName }: Props) {
  ...
  } = useForm<StudentProfileCompleteInput>({
    resolver: zodResolver(studentProfileCompleteSchema),
  })

  async function onSubmit(data: StudentProfileCompleteInput) {
    setServerError("")
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={bloodGroup ?? ""}
                onValueChange={(val) =>
                  setValue("blood_group", val as StudentProfileCompleteInput["blood_group"], {
                    shouldValidate: true,
                  })
                }
              >
