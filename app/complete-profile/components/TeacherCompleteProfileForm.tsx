...
import {
  ...
  type TeacherProfileCompleteInput,
  BLOOD_GROUPS,
...
export function TeacherCompleteProfileForm({ userName }: Props) {
  ...
  } = useForm<TeacherProfileCompleteInput>({
    resolver: zodResolver(teacherProfileCompleteSchema),
  })

  async function onSubmit(data: TeacherProfileCompleteInput) {
    setServerError("")
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <Select
                value={bloodGroup ?? ""}
                onValueChange={(val) =>
                  setValue("blood_group", val as TeacherProfileCompleteInput["blood_group"], {
                    shouldValidate: true,
                  })
                }
              >
