...
import { setActiveUpiAccount } from "@/services/school-upi-account.service"
...
export async function POST(_req: Request, { params }: RouteParams) {
  ...
  try {
    const updated = await setActiveUpiAccount(access.schoolId, session.user.id, id)
    ...
    console.error("[POST upi-accounts/activate]", error)
