...
import { setActiveQrCode } from "@/services/school-qr-code.service"
...
export async function POST(_req: Request, { params }: RouteParams) {
  ...
  try {
    const updated = await setActiveQrCode(access.schoolId, session.user.id, id)
    ...
    console.error("[POST qr-codes/activate]", error)
