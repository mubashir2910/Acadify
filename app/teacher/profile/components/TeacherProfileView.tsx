...
export function TeacherProfileView() {
  ...
  const teacher = profile?.teachers?.[0]
  ...
  function startEdit() {
    ...
    reset({
      ...
      blood_group: (profile.blood_group as TeacherProfileUpdateInput["blood_group"]) ?? undefined,
  ...
  async function onSubmit(data: TeacherProfileUpdateInput) {
    setSaving(true)
    setServerError("")
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {teacher.employee_id} &middot; {profile.email ?? ""}
            </p>
            <p className="text-sm text-muted-foreground">
              ...
              <div className="space-y-1.5">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setValue(
                      "blood_group",
                      val as TeacherProfileUpdateInput["blood_group"],
                      { shouldValidate: true }
                    )
                  }
                >
      ...
      <div className="bg-white rounded-xl border shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
          <InfoField label="Employee ID" value={teacher.employee_id} />
          <InfoField label="Email" value={profile.email ?? "—"} />
          <InfoField label="Joining Date" value={formatDate(teacher.joining_date)} />
          <InfoField label="School" value={teacher.school.schoolName} />
          <InfoField
            label="Class Teacher"
            value={
              teacher.classTeacher
                ? `Class ${teacher.classTeacher.class} - ${teacher.classTeacher.section}`
                : "Not assigned"
            }
          />
        </div>
